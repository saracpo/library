 ...
 * @author Nebojsa
 */
public class BooksByMemberPanel extends javax.swing.JPanel {

    /**
     * Creates new form BooksByMemberPanel
     */
    public BooksByMemberPanel() {
        initComponents();
            ...
            if(m==null) {
                ...
                SwingWorker sw = new SwingWorker() {
                    ...
                    protected Object doInBackground() throws Exception {
                        ...
                        List<RentBook> books = rbDao.getRentBooksByMember(Integer.parseInt(tfId.getText()));
                        return books;
                    }
                    @Override
                    protected void done() {
