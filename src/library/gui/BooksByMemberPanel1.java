 ...
 * @author Nebojsa
 */
public class BooksByMemberPanel1 extends javax.swing.JPanel {
    Member m;
    /**
     * Creates new form BooksByMemberPanel
     */
    public BooksByMemberPanel1(int member_id) throws SQLException {
        initComponents();
        m = MemberDAO.getInstance().getMember(member_id);
        jlName.setText("Ime i prezime: " + m.name);
                ...
                SwingWorker sw = new SwingWorker() {
                    ...
                    protected Object doInBackground() throws Exception {
                        ...
                        List<RentBook> books = rbDao.getRentBooksByMember(member_id);
                        return books;
                    }
                    @Override
                    protected void done() {
                        try {
                            ...
                            if(res.isEmpty()) {
                                JOptionPane.showMessageDialog(jTable1, "Trenutno nema knjiga kod ovog člana");
                                MainForm.mainForm.changeContent(new AllBooksPanel());
                            } else {
                                for (RentBook rb : res) {
                                    dtm.addRow(new Object[]{
                                        rb.book.id, rb.book.title, rb.book.authors, rb.book.genre.name, rb.rentDate.format(dtf), rb.returnDate.format(dtf)
                                    });
                                }
                            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("KNJIGE KOD ČLANA");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Naslov", "Autor", "Žanr", "Uzeto", "Rok za vraćanje"
            }
        ) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jbReturn, javax.swing.GroupLayout.DEFAULT_SIZE, 335, Short.MAX_VALUE)
                        .addGap(26, 26, 26)
                        .addComponent(jbExtend, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jlName)
                            .addComponent(jlJMBG))
    ...
    private void jbReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbReturnActionPerformed
        ...
        if(jTable1.getSelectedRowCount()==0) {
            ...
            try {
                ...
                Logger.getLogger(BooksByMemberPanel1.class.getName()).log(Level.SEVERE, null, ex);
            }
