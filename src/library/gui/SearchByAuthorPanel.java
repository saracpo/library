...
public class SearchByAuthorPanel extends javax.swing.JPanel {
     ...
     */
    public SearchByAuthorPanel() throws SQLException {
        
        initComponents();
        cbAuthors.addItem("Obaberi pisca");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PRETRAGA PO PISCU");

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setText("Odaberi pisca:");

        cbAuthors.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
    ...
    private void jbShowActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbShowActionPerformed
        if(cbAuthors.getSelectedIndex()==0) {
            JOptionPane.showMessageDialog(this, "Niste odabrali pisca!", "Greška!!!", JOptionPane.ERROR_MESSAGE);
        } else {
            Author a = (Author)cbAuthors.getSelectedItem();
            SwingWorker sw = new SwingWorker() {
                @Override
                protected Object doInBackground() throws Exception {
                    BookDAO bookDao = BookDAO.getInstance();
                    List<Book> books = bookDao.getBooksByAuthor(a.id);
                    return books;
                }
    ...
    private javax.swing.JComboBox cbAuthors;
